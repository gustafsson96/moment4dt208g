...
## Description 
This project is a simple single page Angular application that displays courses in a dynamic table with filtering and sorting functionality. The data for the courses is fetched using HttpClient from the JSON file ramschema.json located in the public folder.
...
### Component
The app is created using one single component named "course-list". This component takes care of everything related to the applications functionality (excluding collecting data which is handled by the service mentioned below and then imported into the component).
<br><br>
